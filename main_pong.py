...
# Ball
ball = pygame.Rect(0, 0, 5, 5)
ball.center = (WIDTH/1, HEIGHT/1)

BallSprite = pygame.transform.rotozoom(pygame.image.load("You_are_my_sunshine_vrai.png").convert_alpha(), 0, 0.05)

# Background
BG = pygame.transform.rotozoom(pygame.image.load("Earth_and_Space.jpg").convert(), 0, 0.7)

# Audio
pygame.mixer_music.load("lebron.mp3")
...
while True:
    ...
    SCREEN.blit(BallSprite, ball.center)
